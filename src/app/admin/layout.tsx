  ...
  const groupsCompleto = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/admin/aprendizajes', label: 'Aprendizajes NEM', icon: '🎯' },
        { href: '/admin/banco-preguntas', label: 'Banco de preguntas', icon: '🧠' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/admin/pmi', label: 'PMI (Plan de Mejora)', icon: '🎯' },
