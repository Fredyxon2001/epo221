...
const INSTRUCCIONES = [
  ...
  ['NOMBRE', 'SÍ', 'Texto sin acentos opcional', 'Usado para generar email de login: NOMBRE.APELLIDO@epo221.edu.mx'],
  ...
  [''],
  ['EMAIL DE LOGIN:', '', '', ''],
  [' Patrón base:  nombre.apellido@epo221.edu.mx', '', '', ''],
  [' Ej. "Diego Ramírez" → diego.ramirez@epo221.edu.mx', '', '', ''],
  ...
  ['   diego.ramirez.20260005@epo221.edu.mx', '', '', ''],
  [''],
  ['CONTRASEÑA INICIAL:', '', '', ''],
...
const PREVIEW_LOGIN = [
  ...
  ['Mario García Ramírez', '20260001', 'mario.garcia@epo221.edu.mx', 'TEMPORALEPO221!'],
  ['Camila Hernández Romero', '20260002', 'camila.hernandez@epo221.edu.mx', 'TEMPORALEPO221!'],
  ['Santiago López Luna', '20260003', 'santiago.lopez@epo221.edu.mx', 'TEMPORALEPO221!'],
  [],
  ['EJEMPLO DE DUPLICADO:', '', '', ''],
  ['Diego Ramírez', '20260010', 'diego.ramirez@epo221.edu.mx', 'TEMPORALEPO221!'],
  ['Diego Ramírez', '20260011', 'diego.ramirez.20260011@epo221.edu.mx', 'TEMPORALEPO221!'],
